        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    MonthlyClassCount = table.Column<int>(type: "INTEGER", nullable: false),
                    CurrentMonthYear = table.Column<string>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_PlanTypes_PlanTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanTypes_Name",
                table: "PlanTypes",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Students_PlanTypeId",
                table: "Students",
                column: "PlanTypeId");
        }
